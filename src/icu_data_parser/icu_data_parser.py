...
class ICUDataParser:
    def __init__(self, logger):
        ...
        headers = ["patient_id", "date_of_birth", "timestamp", "cpp", "glucose", "haemoglobin", "heart_rate", "icp",
    ...
    def parse(self, files):
        ...
        for file in files:
            ...
            if file_name == "episodes with high icp.txt":
    ...
    def add_date_of_birth_for_patient(self, patient_id, date_of_birth):
        ...
        for data in self.final_data:
            if data[:2] == [patient_id]:
                data[self.column_index["date_of_birth"]] = value
                return
        ...
        # Set patient_id and the timestamp
        new_element[self.column_index["patient_id"]] = patient_id
        new_element[self.column_index["date_of_birth"]] = date_of_birth
